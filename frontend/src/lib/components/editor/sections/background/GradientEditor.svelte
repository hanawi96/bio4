		...
		<div class="grid grid-cols-8 gap-2">
			{#each gradients as grad}
				<button
					...
					class="relative aspect-square rounded-lg border transition-all hover:scale-105 {normalizeGradient(currentBgColor) === normalizeGradient(grad.gradient) ? 'border-[#00aa4f] ring-2 ring-[#00aa4f]/20' : 'border-gray-200'}"
			...
			<button
				...
				class="relative aspect-square rounded-lg border transition-all hover:scale-105 {isCustomGradient ? 'border-[#00aa4f] ring-2 ring-[#00aa4f]/20' : showCustomGradient ? 'border-[#00aa4f] ring-2 ring-[#00aa4f]/20 bg-[#e6f7ed]' : 'border-dashed border-gray-300 hover:border-gray-400 bg-white'}"
			...
			>
				...
				{:else}
					<svg class="absolute inset-0 m-auto w-5 h-5 {showCustomGradient ? 'text-[#00aa4f]' : 'text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			<div class="grid grid-cols-2 gap-3">
				<div>
					...
					<div class="relative">
						...
						<div class="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded-lg hover:border-gray-300 transition cursor-pointer">
							<div class="w-8 h-8 rounded border border-gray-200" style="background-color: {gradientFromColor};"></div>
				...
				<div>
					...
					<div class="relative">
						...
						/>
						<div class="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded-lg hover:border-gray-300 transition cursor-pointer">
							<div class="w-8 h-8 rounded border border-gray-200" style="background-color: {gradientToColor};"></div>
			...
			<div>
				...
				<div class="grid grid-cols-2 gap-2">
					<button
						...
						class="px-3 py-2 rounded-lg text-xs font-medium transition {gradientType === 'linear' ? 'bg-[#00aa4f] text-white' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'}"
					>
						Linear
					</button>
					<button
						on:click={() => handleTypeChange('radial')}
						class="px-3 py-2 rounded-lg text-xs font-medium transition {gradientType === 'radial' ? 'bg-[#00aa4f] text-white' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'}"
					>
						Radial
					</button>
				</div>
				...
				<div>
					...
					<div class="grid grid-cols-4 gap-2">
						<button
							...
							class="p-2 rounded-lg transition {gradientDirection === '0deg' ? 'bg-[#00aa4f] text-white' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'}"
							title="Top to Bottom"
						>
						...
						<button
							...
							class="p-2 rounded-lg transition {gradientDirection === '90deg' ? 'bg-[#00aa4f] text-white' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'}"
							title="Left to Right"
						>
							<svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
						...
						<button
							...
							class="p-2 rounded-lg transition {gradientDirection === '135deg' ? 'bg-[#00aa4f] text-white' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'}"
							title="Diagonal"
						>
							<svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
						...
						<button
							...
							class="p-2 rounded-lg transition {gradientDirection === '180deg' ? 'bg-[#00aa4f] text-white' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'}"
							title="Bottom to Top"
						>
							<svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
