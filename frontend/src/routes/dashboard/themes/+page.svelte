			...
			{#each themes as theme}
				...
				<div class="group bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 relative">
					...
					<button
						...
						class="absolute top-3 right-3 z-10 w-8 h-8 bg-red-500 text-white rounded-full opacity-0 group-hover:opacity-100 hover:bg-red-600 transition-all flex items-center justify-center shadow-lg"
						title="Delete theme"
					>
